    ...
    <>
      ...
      <section className="max-w-[1360px]   m-auto mt-[27px] relative overflow-hidden bg-[#EEF5FF]   rounded-[29px] shadow-[0px_4px_65px_1px_#00072B36]">
        ...
        <div className="flex justify-around items-center px-[45px] ">
          <div className=" w-full max-w-[502px]">
            ...
            <button className="bg-[#1A73E8] text-[#FFFFFF] font-normal text-[20px] px-[52px] py-[15px] rounded-[8px]" onClick={() => setModalOpen(true)}>
              Refer Now
            </button>
          </div>
          <div className="z-10">
      ...
      <section className=" max-w-[1934px] bg-[#EEF5FF] m-auto mt-[75px] p-[25px]">
        <div className="max-w-[1387px] m-auto">
          ...
          <button onClick={() => setModalOpen(true)} className="text-[#FFFFFF] block mx-auto bg-[#1A73E8] py-[20px] px-[72px] rounded-[8px] font-[Source Sans Pro] font-normal text-[20px]">
            Refer Now
          </button>
        </div>
      </section>
      ...
      <section className=" max-w-[1926px]  m-auto mt-[91px]">
          ...
          <div className=" flex  gap-[40px] m-auto   font-[Source Sans Pro]  text-[18px] pt-[33px]  pb-[65px] relative">
            ...
            <table className="font-normal w-full border-collapse flex-6 shadow-[0px_4px_29.3px_0px_#3C3C3C26]">
              <thead className="font-bold bg-[#1A73E859] text-[#1350A0] rounded-t-[14px] ">
                <tr className="">
                  <th className="rounded-tl-[14px] py-[14px] text-left px-[20px]">Programs</th>
                  <th className="border-l border-r border-gray-600 py-[14px] px-[7px]">Referrer Bonus</th>
                  <th className="rounded-tr-[14px] py-[14px] px-[7px]">Referee Bonus</th>
                </tr>
              </thead>
              <tbody className="text-center">
                ...
                <tr >
                  ...
                  <td className="border-l border-r border-gray-600">₹ 10,000</td>
                  <td>₹ 10,000</td>
                </tr>
                <tr>
                  <td className="flex items-center gap-x-2 text-left py-[20px] px-[10px]">
        ...
        <button onClick={() => setModalOpen(true)} className="bg-[#1A73E8] font-[Source Sans Pro] font-normal text-[20px] py-[20px] px-[69px] text-[#FFFFFF] rounded-[8px] block m-auto" >Refer Now</button>
      </section>
{/* section frequent */}
...
<footer className=" bg-[#282828] text-[#FFFFFF] font-roboto mt-[120px] py-[32px]">
    ...
    <div className="flex justify-between m-auto max-w-[1152px]">
        <div><img src={footlogo} alt="" /></div>
        <div className=" flex flex-col">
            <button className="font-medium text-[14px] text-center bg-[#007BFF] border rounded-[8px]  py-[7px] px-[39.53px]">Schedule 1-on-1 Call Now</button>
            <p className="font-normal text-[14px] text-center ">Speak with our Learning Advisor</p>
        </div>
    </div>
    <div className=" border-t-[2px] border-gray-400 m-auto mt-[32.5px] max-w-[1152px] p-[16px] flex   gap-[20px] justify-between">
        <div className="flex-1  ">
            ...
            <ul className="flex flex-col gap-[30px]">
                <li className="flex items-center justify-between text-[17px] gap-[10px]">Data Science & AI <img src={plus}/></li>
                <li className="flex items-center justify-between text-[17px] gap-[10px]">Product Management<img src={plus}/></li>
                <li className="flex items-center justify-between text-[17px] gap-[10px]">Business Analytics<img src={plus}/></li>
                <li className="flex items-center justify-between text-[17px] gap-[10px]">Digital Transformation<img src={plus}/></li>
                <li className="flex items-center justify-between text-[17px] gap-[10px]">Business Management<img src={plus}/></li>
                <li className="flex items-center justify-between text-[17px] gap-[10px]">Project Management<img src={plus}/></li>
                <li className="flex items-center justify-between text-[17px] gap-[10px]">Strategy & Leadership<img src={plus}/></li>
                <li className="flex items-center justify-between text-[17px] gap-[10px]">Senior Management<img src={plus}/></li>
                <li className="flex items-center justify-between text-[17px] gap-[10px]">Fintech<img src={plus}/></li>
            </ul>
        </div>
        <div className="flex-2  ">
            ...
            <div>
                <ul className="font-roboto font-normal text-[14px] ">
                    ...
                    <li>Office Address: 4th Floor, 250, Phase IV, Udyog Vihar, Sector 18, Gurugram,
                    Haryana 122015</li>
                </ul>
            </div>
            <p className="font-roboto font-normal text-[18px]">Why Accredian</p>
        ...
        <div className=" flex-1  ">
            ...
            <ul>
                <li className="flex items-center justify-between text-[14px]">About </li>
                <li className="flex items-center justify-between text-[14px]">Career</li>
                <li className="flex items-center justify-between text-[14px]">Blog</li>
                <li className="flex items-center justify-between text-[14px]">Admission Policy</li>
                <li className="flex items-center justify-between text-[14px]">Referral Policy</li>
                <li className="flex items-center justify-between text-[14px]">Privacy Policy</li>
                <li className="flex items-center justify-between text-[14px]">Terms Of Service</li>
                <li className="flex items-center justify-between text-[14px]">Master FAQs</li>
            </ul>
        </div>
    </div>
    <p className=" font-normal text-[14px] text-center py-[40px]">© 2024 Accredian A Brand of FullStack Education Pvt Ltd. All Rights Reserved</p>
    </div>
</footer>
    </>
  );
